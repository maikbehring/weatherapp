import { i as invariant } from './ssr.mjs';
import { z } from 'zod';
...
const readinessApi = {
  ...
  setIsReady: async () => {
    const config2 = await mwExtBridge.connection.getConfig();
    mwExtBridge.config = parseConfig(config2);
    resolveReadiness();
  }
};
...
globalThis.mwExtBridge = mwExtBridge$1;
...
class JOSEError extends Error {
  constructor(message2, options) {
    ...
    (_a22 = Error.captureStackTrace) == null ? void 0 : _a22.call(Error, this, this.constructor);
  }
}
...
function message(msg, actual, ...types) {
  ...
  if (actual == null) {
    ...
    if ((_a22 = actual.constructor) == null ? void 0 : _a22.name) {
...
const genericImport = async (keyFormat, keyData, alg, options) => {
  ...
  return crypto.subtle.importKey(keyFormat, keyData, algorithm, (_a3 = options == null ? void 0 : options.extractable) != null ? _a3 : true, keyUsages);
};
...
const fromSPKI = (pem, alg, options) => {
  ...
  let opts = options;
  if ((_a22 = alg.startsWith) == null ? void 0 : _a22.call(alg, "ECDH-ES")) {
    opts || (opts = {});
...
const importJWK = async (jwk) => {
  ...
  delete keyData.use;
  return crypto.subtle.importKey("jwk", keyData, algorithm, (_a3 = jwk.ext) != null ? _a3 : jwk.d || jwk.priv ? false : true, (_b2 = jwk.key_ops) != null ? _b2 : keyUsages);
};
...
const handleJWK = async (key, jwk, alg, freeze = false) => {
  cache$1 || (cache$1 = /* @__PURE__ */ new WeakMap());
...
const handleKeyObject = (keyObject, alg) => {
  ...
  if (keyObject.asymmetricKeyType === "ec") {
    ...
    const namedCurve = nist.get((_a22 = keyObject.asymmetricKeyDetails) == null ? void 0 : _a22.namedCurve);
    if (!namedCurve) {
      throw new TypeError("given KeyObject instance cannot be used for this algorithm");
    }
...
const jwkMatchesOp = (alg, key, usage) => {
  ...
  if (Array.isArray(key.key_ops)) {
    ...
    if (expectedKeyOp && ((_b2 = (_a22 = key.key_ops) == null ? void 0 : _a22.includes) == null ? void 0 : _b2.call(_a22, expectedKeyOp)) === false) {
...
const verify$1 = async (alg, key, signature, data) => {
...
async function flattenedVerify(jws, key, options) {
  ...
  const extensions = validateCrit(JWSInvalid, /* @__PURE__ */ new Map([["b64", true]]), void 0 , parsedProt, joseHeader);
  let b64 = true;
  ...
  const data = concat(encoder.encode((_a3 = jws.protected) != null ? _a3 : ""), encoder.encode("."), typeof jws.payload === "string" ? encoder.encode(jws.payload) : jws.payload);
  let signature;
  try {
...
async function compactVerify(jws, key, options) {
  ...
  const verified = await flattenedVerify({ payload, protected: protectedHeader, signature }, key);
...
async function jwtVerify(jwt, key, options) {
  ...
  if (((_a22 = verified.protectedHeader.crit) == null ? void 0 : _a22.includes("b64")) && verified.protectedHeader.b64 === false) {
...
const __vite_import_meta_env__ = { "BASE_URL": "/", "DEV": true, "MODE": "production", "PROD": false, "SSR": true, "TSS_APP_BASE": "/", "TSS_OUTPUT_PUBLIC_DIR": "/Users/mbehring/Documents/Cursor/mittvibes/weatherapp/dist", "TSS_SERVER_FN_BASE": "/_serverFn", "VITE_USER_NODE_ENV": "development" };
const r = /* @__PURE__ */ Object.create(null), i = (e) => {
  var _a22, _b2;
  return ((_a22 = globalThis.process) == null ? void 0 : _a22.env) || __vite_import_meta_env__ || ((_b2 = globalThis.Deno) == null ? void 0 : _b2.env.toObject()) || globalThis.__env__ || (e ? r : globalThis);
}, o = new Proxy(r, { get(e, s) {
  var _a3;
  return (_a3 = i()[s]) != null ? _a3 : r[s];
}, has(e, s) {
  const E = i();
...
function b() {
  ...
  if ((_a22 = globalThis.process) == null ? void 0 : _a22.env) for (const e of f) {
    const s = e[1] || e[0];
...
const MW_EXT_API_URL = (_a2 = o["MW_EXT_API_URL"]) != null ? _a2 : "https://api.mittwald.de";
...
const verifyAccessToInstance = createMiddleware({
  type: "function",
  validateClient: true
}).client(async ({
  next
...
export { createServerRpc as c, verifyAccessToInstance as v };
//# sourceMappingURL=verify-access-to-instance-B19RDFwj.mjs.map
